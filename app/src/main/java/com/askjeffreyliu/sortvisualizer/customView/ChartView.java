package com.askjeffreyliu.sortvisualizer.customView;
...
import com.askjeffreyliu.sortvisualizer.R;
...
//        }
        ...
        try {
            barColor = a.getColor(R.styleable.ChartView_barColor, Color.BLUE);
